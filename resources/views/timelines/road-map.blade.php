...
@section('title', $timeline?->meta_title ?? __('socialprofile::messages.timelines.road_map.title'))
...
<div class="container socialprofile-timeline-page">
    <h1 class="mb-2">{{ $timeline->title ?? __('socialprofile::messages.timelines.road_map.title') }}</h1>
    <p class="lead text-muted">{{ $timeline->subtitle ?? __('socialprofile::messages.timelines.road_map.subtitle') }}</p>
    ...
    @else
        <div class="alert alert-info">
            {{ __('socialprofile::messages.timelines.road_map.empty') }}
        </div>
    @endif
</div>
@endsection
